...
public interface TaUsagePonitDataMapper {
    ...
    public List<TaUsagePointData> findUsagePointByPointIdAndTime(@Param("startExpDate")long startExpDate, @Param("endExpDate")long endExpDate, @Param("point_id") int pointId);
